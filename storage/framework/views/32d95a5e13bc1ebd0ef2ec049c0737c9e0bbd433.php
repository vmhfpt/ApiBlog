                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="<?php echo e(route('post.admin.update', ['slug' => $dataItem->slug])); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                                      <div class="form-group">
                                        ...
                                        <input value="<?php echo e(old('key_seo') ? old('key_seo') : $dataItem->getPostMeta->key); ?>" type="text" name="key_seo" class="form-control" id="exampleInputEmail1"
...
unset($__errorArgs, $__bag); ?>
                                      <div class="form-group">
                                        ...
                                        <input value="<?php echo e(old('description') ? old('description') : $dataItem->description); ?>" type="text" name="description" class="form-control" id="exampleInputEmail1"
...
unset($__errorArgs, $__bag); ?>
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" class="form-control">
                                           ...
                                           <option <?php echo e($dataItem->getPostCategory->getCategory->id == $value->id ?  'selected' : ''); ?> value="<?php echo e($value->id); ?>"><?php echo e($value->title); ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="tag_id" class="form-control">
                                           ...
                                           <option <?php echo e($dataItem->getPostTag->getTag->id == $value->id ?  'selected' : ''); ?> value="<?php echo e($value->id); ?>"><?php echo e($value->title); ?></option>
                                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input <?php echo e($dataItem->active == 1 ? 'checked' :''); ?> name="active" type="checkbox" class="custom-control-input" id="customSwitch1">
...
unset($__errorArgs, $__bag); ?>
                                    <img id="imgSrc" src="<?php echo e(url($dataItem->thumb)); ?>"
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LaraveBlog\resources\views/admin/post/edit.blade.php ENDPATH**/ ?>