                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('post.admin.update', ['slug' => $dataItem->slug]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-danger alert-dismissible fade show">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input value="{{old('key_seo') ? old('key_seo') : $dataItem->getPostMeta->key}}" type="text" name="key_seo" class="form-control" id="exampleInputEmail1"
                                    ...
                                    <div class="alert alert-danger alert-dismissible fade show">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input value="{{old('description') ? old('description') : $dataItem->description}}" type="text" name="description" class="form-control" id="exampleInputEmail1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" class="form-control">
                                           ...
                                           <option {{$dataItem->getPostCategory->getCategory->id == $value->id ?  'selected' : ''}} value="{{$value->id}}">{{$value->title}}</option>
                                           @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="tag_id" class="form-control">
                                           ...
                                           <option {{$dataItem->getPostTag->getTag->id == $value->id ?  'selected' : ''}} value="{{$value->id}}">{{$value->title}}</option>
                                           @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    @enderror
                                    <img id="imgSrc" src="{{url($dataItem->thumb)}}"
