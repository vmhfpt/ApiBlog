      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{asset('admin/tag/list')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh sách tag</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{asset('admin/tag/add')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm tag mới</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{asset('admin/post/list')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh bài viết</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{asset('admin/post/add')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm bài viết</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{asset('admin/footer/list')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh sách chân trang</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{asset('admin/footer/add')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm chân trang</p>
                </a>
              </li>
